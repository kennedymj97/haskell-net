...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { a9: 'hidden', a_: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { a9: 'mozHidden', a_: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { a9: 'msHidden', a_: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { a9: 'webkitHidden', a_: 'webkitvisibilitychange' }
		: { a9: 'hidden', a_: 'visibilitychange' };
}
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.bc, request.bC, true);
		} catch (e) {
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {aj: fragment, ao: host, av: path, ax: port_, aA: protocol, aB: query};
	});
...
var $author$project$Main$convertToGray = function (arr) {
		...
		A3(
			...
			F2(
				function (_v0, acc) {
					var idx = _v0.a;
					var val = _v0.b;
					return (!A2($elm$core$Basics$modBy, 4, idx)) ? A2($elm$core$List$cons, val, acc) : acc;
				}),
			_List_Nil,
...
var $author$project$Main$calcPixelVal = F4(
	function (n, zf, idx, arr) {
		return 255 - (A3(
			$elm$core$List$foldr,
			F2(
				function (y, acc) {
						...
						F2(
							function (x, acc2) {
								return acc2 + A2(
									...
									255,
									A2($elm$core$Array$get, y + x, arr));
							}),
						acc,
						A2($elm$core$List$range, 0, zf - 1));
				}),
			0,
			A2(
				$elm$core$List$map,
				function (val) {
					return idx + (val * $elm$core$Basics$round(n));
				},
				A2($elm$core$List$range, 0, zf - 1))) / A2($elm$core$Basics$pow, zf, 2));
	});
...
var $author$project$Main$roundToNearestMult = F2(
	function (r, x) {
		return $elm$core$Basics$floor(
			r * $elm$core$Basics$round(x / r));
	});
var $author$project$Main$topLeftIdx = F3(
	function (n, z, idx) {
		return $elm$core$Basics$floor(
			A2($elm$core$Basics$modBy, 28, idx) * z) + A2($author$project$Main$roundToNearestMult, n, (n * z) * ((idx / 28) | 0));
	});
var $author$project$Main$downsampleImg = function (arr) {
	var l = $elm$core$Array$length(arr);
	var n = $elm$core$Basics$sqrt(l);
	var z = n / 28;
	var zf = $elm$core$Basics$floor(z);
	return $elm$core$Array$fromList(
		A3(
			$elm$core$List$foldr,
			F2(
				function (idx, acc) {
					return A2(
						$elm$core$List$cons,
						A4(
							$author$project$Main$calcPixelVal,
							n,
							zf,
							A3($author$project$Main$topLeftIdx, n, z, idx),
							arr),
						acc);
				}),
			_List_Nil,
			A2($elm$core$List$range, 0, 783)));
};
var $author$project$Main$formatRawData = A2($elm$core$Basics$composeR, $author$project$Main$convertToGray, $author$project$Main$downsampleImg);
var $author$project$Main$getProbs = function (result) {
	if (!result.$) {
		var raw = result.a;
		return $author$project$Main$SendImage(
			$author$project$Main$formatRawData(raw));
	} else {
...
var $author$project$Main$decodeProbs = A2(
	$elm$json$Json$Decode$field,
	'probs',
...
var $author$project$Main$encodeImg = function (img) {
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'img',
				A2($elm$json$Json$Encode$array, $elm$json$Json$Encode$float, img))
			]));
};
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{aX: false, Q: r.Q, a4: r.a4, am: r.am, bc: r.bc, bA: r.bA, aQ: r.aQ, bC: r.bC}));
};
var $elm$http$Http$post = function (r) {
	return $elm$http$Http$request(
		{Q: r.Q, a4: r.a4, am: _List_Nil, bc: 'POST', bA: $elm$core$Maybe$Nothing, aQ: $elm$core$Maybe$Nothing, bC: r.bC});
};
var $author$project$Main$postImg = function (img) {
		...
		switch (msg.$) {
			case 0:
				...
				return _Utils_Tuple2(
					...
					$author$project$Main$postImg(img));
			case 1:
				var result = msg.a;
				if (!result.$) {
					var data = result.a;
					return _Utils_Tuple2(
						$author$project$Main$Probs(data),
	...
	[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$href('https://blog.jle.im/entry/practical-dependent-types-in-haskell-1.html')
					]),
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$href('http://yann.lecun.com/exdb/mnist/')
					]),
				_List_fromArray(
					[
		...
		_List_fromArray(
			[
				$elm$html$Html$text('Improvements')
			])),
		A2(
		$elm$html$Html$h3,
		_List_Nil,
		...
		_List_fromArray(
			[
				$elm$html$Html$text('Sigmoid vs Softmax')
			])),
		A2(
		$elm$html$Html$p,
		_List_Nil,
...
var $author$project$Main$getCertainty = function (xs) {
	...
	if (!_v0.$) {
		var x = _v0.a;
		return $author$project$Main$probToPercentage(x);
	} else {
		return '-';
	}
};
var $author$project$Main$extracitIdx = function (t) {
	if (!t.$) {
		var _v1 = t.a;
		var x = _v1.a;
		var y = _v1.b;
...
var $author$project$Main$getPrediction = function (xs) {
	return $author$project$Main$extracitIdx(
...
var $author$project$Main$probabilityLine = function (val) {
	return A2(
		$elm$svg$Svg$svg,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$svg$Svg$Attributes$x1('3.5%'),
						$elm$svg$Svg$Attributes$y1('50%'),
						$elm$svg$Svg$Attributes$x2(
						$elm$core$String$fromFloat(3.5 + (val * 93)) + '%'),
...
var $author$project$Main$visualiseProb = function (_v0) {
	var prob = _v0.a;
	var idx = _v0.b;
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('visualise-prob')
			]),
		_List_fromArray(
			[
				$elm$html$Html$text(
				$elm$core$String$fromInt(idx) + ': '),
				$author$project$Main$probabilityLine(prob),
				$elm$html$Html$text(
				$author$project$Main$probToPercentage(prob))
			]));
};
var $author$project$Main$visualiseProbs = function (xs) {
	if (!xs.b) {
		return A2(
			$elm$core$List$map,
			$author$project$Main$visualiseProb,
			$author$project$Main$indexProbs(
...
var $author$project$Main$main = $elm$browser$Browser$document(
	{bb: $author$project$Main$init, bx: $author$project$Main$subscriptions, bB: $author$project$Main$update, bD: $author$project$Main$view});
